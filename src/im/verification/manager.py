...
class IMVerificationManager:
    ...
    def verify(self, user_id: str, code: str, nickname: Optional[str] = None) -> tuple[bool, str]:
        """
        验证验证码
    ...
    def get_verified_user(self, user_id: str) -> Optional[VerifiedUser]:
        """
        获取已验证用户信息
    ...
    def get_pending_session(self, user_id: str) -> Optional[VerificationSession]:
        """
        获取待验证会话
